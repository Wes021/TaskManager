...
namespace Tasks.Tasks.Infrastructure.Repositories
{
    public class TasksRepository : ITasksRepository
    {
        ...
        {
            IQueryable<Domain.Models.Tasks> query = _context.Task.Where(x => x.IsDeleted != true).Include(x => x.TasksStatus).Include(x => x.TaskAttachments.Where(att => !att.IsDeleted)).Include(x => x.Members.Where(me => !me.IsDeleted)).Include(x => x.TaskComments.Where(com => !com.IsDeleted)).Include(x => x.TaskHistory.Where(history => !history.IsDeleted));
